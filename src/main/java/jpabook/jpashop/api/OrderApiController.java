...
public class OrderApiController {
    ...
    public List<OrderDto> ordersV3() {
        ...
        List<OrderDto> collect = orders.stream().map(o -> new OrderDto(o)).collect(toList());
        // 문제점 : 1대다 조인이 있어서 같은 객체를 여러번 반환한다. -> 관계형 DB와 자바의 차이에서 발생하는 문제 -> distinct로 중복을 풀어줘야한다.
        return collect;
    }
    ...
    @Data // -> jackson이 json을 만들 때 자바 프로퍼티 접근법으로 getter로 값 가져와서 json 만들어서 getter 필요!!
